using CodeAndPlay.Security.Model;
...
namespace CodeAndPlay.Security.Data.Repository
{
    public class SecurityRepository : ISecurityRepository
    {
        private SymposiumAuthContext context;
        private UserManager<IdentityUser> manager;

        public SecurityRepository(SymposiumAuthContext context)
        {
